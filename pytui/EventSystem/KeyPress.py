...
class KeyPressEventListener(EventListener):
    ...
    def notify(self, sender, key, key2=b'\x00'):
        ...
        Args:
            sender: A KeyPressEventHandler object.
            key: The base key code.
            key2: Modifier key code, if available. See KeyCodes class for more info.
        """
...
# 1.1
"""
    Bug fixes and code refactoring for legibility.
    
    Changes
    -------
        - Commenting & code region formatting
    
    Bug Fixes
    ---------
        - Fixed code usage for KeyPressEventHandler.__UnixKeyPress.__call__()
            - Previously called the wrong termios function: should be tcsetattr instead of tesetattr
"""
