...
To use this module in another project, include this file inside the project's directory."""
    ...
    print("========================================================")
    print("OnFocus.py version ", __MAJOR, ".", __MINOR, sep='', end='\n\n')
    print(__info)
    print("========================================================\n")
...
class OnFocusEventListener(EventListener):
    ...
    def notify(self, sender):
        ...
        EventListener.notify(self, sender, OnFocusEventArgs())

#endregion OnFocusEventListener


#region ======================== OnFocusEventHandler ========================

class OnFocusEventHandler(EventHandler):

    def __init__(self, *subscribers: Callable[[Any, OnFocusEventArgs], None]):

        EventHandler.__init__(self, OnFocusEventListener(*subscribers))

#endregion OnFocusEventHandler
